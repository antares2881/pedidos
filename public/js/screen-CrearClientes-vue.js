(self["webpackChunk"] = self["webpackChunk"] || []).push([["screen-CrearClientes-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      ...
      saving: false,
      erroresCliente: {},
      // ahora objeto con errores por campo
      estados: [{
        text: 'Activo',
        value: 9
      }, {
  ...
  methods: {
    ...
    editCliente: function editCliente(item) {
    ...
    getMunicipios: function getMunicipios() {
      var _this = this;
      axios.get('/municipios').then(function (res) {
        _this.municipios = [];
        // console.log(res.data)
        for (var i = 0; i < res.data.length; i++) {
          _this.municipios.push({
            value: res.data[i].id,
    ...
    saveCliente: function saveCliente() {
      var _this2 = this;
      this.saving = true;
      this.erroresCliente = {};
      console.log(this.cliente);
      axios.post('/clientes', this.cliente).then(function (res) {
        _this2.saving = false;
        if (res.data.id) {
          _this2.$emit('cliente_id', res.data);
          _this2.dialogClient = false;
        } else {
          // backend puede devolver errors o directamente un objeto con mensajes
          _this2.erroresCliente = res.data.errors || res.data || {};
        }
      })["catch"](function (err) {
        _this2.saving = false;
        // captura validación 422 de Laravel
        if (err.response && err.response.status === 422) {
          _this2.erroresCliente = err.response.data.errors || {};
        } else {
          console.log(err);
        }
      });
    ...
    updateCliente: function updateCliente() {
      ...
      this.saving = true;
      this.erroresCliente = {};
      axios.put("/clientes/".concat(this.cliente.id), this.cliente).then(function (res) {
        _this3.saving = false;
        if (res.data === 'ok') {
          Swal.fire({
            icon: 'success',
          ...
          _this3.erroresCliente = res.data.errors || res.data || {};
        }
      })["catch"](function (err) {
        _this3.saving = false;
        if (err.response && err.response.status === 422) {
          _this3.erroresCliente = err.response.data.errors || {};
        } else {
          console.log(err);
        }
      });
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_style_index_0_id_b173f9f6_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6 ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("b-modal", {
    ...
    "class": {
      "is-invalid": _vm.hasError("municipio_id")
    },
    attrs: {
    ...
    model: {
      value: _vm.cliente.municipio_id,
      callback: function callback($$v) {
        _vm.$set(_vm.cliente, "municipio_id", $$v);
      },
      expression: "cliente.municipio_id"
    }
  }), _vm._v(" "), _vm.hasError("municipio_id") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("municipio_id")))]) : _vm._e()], 1), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "tipocliente_id"
    }
  }, [_vm._v("Tipo de cliente")]), _vm._v(" "), _c("b-form-select", {
    "class": {
      "is-invalid": _vm.hasError("tipocliente_id")
    },
    attrs: {
      id: "tipocliente_id",
      options: _vm.tipoClientes
    },
    model: {
      value: _vm.cliente.tipocliente_id,
      callback: function callback($$v) {
        _vm.$set(_vm.cliente, "tipocliente_id", $$v);
      },
      expression: "cliente.tipocliente_id"
    }
  }), _vm._v(" "), _vm.hasError("tipocliente_id") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("tipocliente_id")))]) : _vm._e()], 1), _vm._v(" "), _c("div", {
    staticClass: "col-4"
  }, [_c("label", {
    attrs: {
      "for": "nit"
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.cliente, "nit", _vm._n($event.target.value));
      },
      blur: function blur($event) {
        return _vm.$forceUpdate();
      }
    }
  }), _vm._v(" "), _vm.hasError("nit") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("nit")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-2"
  }, [_c("label", {
    attrs: {
      "for": "dv"
    }
  }, [_vm._v("D.V")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model.number",
      value: _vm.cliente.dv,
      expression: "cliente.dv",
      modifiers: {
        number: true
      }
    }],
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.cliente, "dv", _vm._n($event.target.value));
      },
      blur: function blur($event) {
        return _vm.$forceUpdate();
      }
    }
  }), _vm._v(" "), _vm.hasError("dv") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("dv")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-12"
  }, [_c("label", {
    attrs: {
      "for": "razon_social"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.cliente.razon_social,
      expression: "cliente.razon_social"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.hasError("razon_social")
    },
    attrs: {
      type: "text",
      id: "razon_social"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.cliente, "razon_social", $event.target.value);
      }
    }
  }), _vm._v(" "), _vm.hasError("razon_social") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("razon_social")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "contacto_comercial"
    }
  }, [_vm._v("Contacto comercial")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.cliente.contacto_comercial,
      expression: "cliente.contacto_comercial"
    }],
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.hasError("contacto_comercial")
    },
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.cliente, "contacto_comercial", $event.target.value);
      }
    }
  }), _vm._v(" "), _vm.hasError("contacto_comercial") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("contacto_comercial")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "direccion"
    ...
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.hasError("direccion")
    },
    attrs: {
      type: "text",
      id: "direccion"
  ...
  }), _vm._v(" "), _vm.hasError("direccion") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("direccion")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "telefono"
    ...
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.hasError("telefono")
    },
    attrs: {
      type: "text",
      id: "telefono"
  ...
  }), _vm._v(" "), _vm.hasError("telefono") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("telefono")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "email"
    ...
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("email")))]) : _vm._e()]), _vm._v(" "), _vm.editar ? _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "estado_id"
    }
  }, [_vm._v("Estado")]), _vm._v(" "), _c("b-select", {
    "class": {
      "is-invalid": _vm.hasError("estado_id")
    },
    attrs: {
      options: _vm.estados
    },
    model: {
      value: _vm.cliente.estado_id,
      callback: function callback($$v) {
        _vm.$set(_vm.cliente, "estado_id", $$v);
      },
      expression: "cliente.estado_id"
    }
  }), _vm._v(" "), _vm.hasError("estado_id") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("estado_id")))]) : _vm._e()], 1) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "col-12"
  }, [_c("div", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.cliente.aplicaretencion,
      expression: "cliente.aplicaretencion"
    }],
    ...
    domProps: {
      checked: Array.isArray(_vm.cliente.aplicaretencion) ? _vm._i(_vm.cliente.aplicaretencion, null) > -1 : _vm.cliente.aplicaretencion
    },
    on: {
      change: function change($event) {
        var $$a = _vm.cliente.aplicaretencion,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.cliente, "aplicaretencion", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.cliente, "aplicaretencion", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.cliente, "aplicaretencion", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("label", {
  ...
  }, [_vm._v("Aplica retención")])])]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("button", {
    ...
    staticClass: "col-6"
  }, [_vm.editar ? _c("button", {
    staticClass: "btn btn-warning btn-block",
    attrs: {
      disabled: _vm.saving
    },
    on: {
      click: _vm.updateCliente
    }
...
/***/ "./resources/js/components/CrearClientes.vue":
/*!***************************************************!*\
  !*** ./resources/js/components/CrearClientes.vue ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CrearClientes.vue?vue&type=template&id=b173f9f6 */ "./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6");
/* harmony import */ var _CrearClientes_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CrearClientes.vue?vue&type=script&lang=js */ "./resources/js/components/CrearClientes.vue?vue&type=script&lang=js");
/* harmony import */ var _CrearClientes_vue_vue_type_style_index_0_id_b173f9f6_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css */ "./resources/js/components/CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _CrearClientes_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__.render,
  _CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
{ var api; }
component.options.__file = "resources/js/components/CrearClientes.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/CrearClientes.vue?vue&type=script&lang=js":
/*!***************************************************************************!*\
  !*** ./resources/js/components/CrearClientes.vue?vue&type=script&lang=js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CrearClientes.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css":
/*!***********************************************************************************************!*\
  !*** ./resources/js/components/CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_style_index_0_id_b173f9f6_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=style&index=0&id=b173f9f6&lang=css");


/***/ }),

/***/ "./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6 ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CrearClientes_vue_vue_type_template_id_b173f9f6__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CrearClientes.vue?vue&type=template&id=b173f9f6 */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CrearClientes.vue?vue&type=template&id=b173f9f6");
