(self["webpackChunk"] = self["webpackChunk"] || []).push([["screen-ItemsComponent-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    scheduleModalPreload: function scheduleModalPreload() {
      var preload = function preload() {
        if (typeof window.preloadVueScreen !== 'function') {
          return;
        }
        ['ViewHistoryPrice', 'CrearClientes', 'ModalfacturasPendientes', 'InformacionFinalFacturas', 'ModalItem'].forEach(function (file) {
          window.preloadVueScreen(file)["catch"](function () {});
        });
      };

      // Dejar terminar primero la pantalla y sus datos esenciales.
      this.modalPreloadTimer = setTimeout(function () {
    ...
    ensureModal: function ensureModal(modal, refName) {
      var _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              if (!_this.mountedModals[modal]) {
                _this.$set(_this.mountedModals, modal, true);
              }
              attempt = 0;
            case 1:
              if (!(attempt < 500)) {
            ...
            case 2:
              ...
              return _context.a(2, _this.$refs[refName]);
            case 3:
              _context.n = 4;
              return new Promise(function (resolve) {
            ...
            case 4:
              ...
              break;
            case 5:
              throw new Error("No fue posible cargar el modal ".concat(refName));
            case 6:
              return _context.a(2);
          }
        }, _callee);
    ...
    addBonus: function addBonus(index) {
      var bonus = document.getElementById('bonus' + index).value;
      if (bonus < 0) {
    ...
    addProducto: function addProducto(item, index) {
      // console.log(item)
      ...
      this.$nextTick(function () {
        var row = document.getElementById('row-' + item.codigo);
    ...
    calculaTotalPedido: function calculaTotalPedido() {
      this.totalPedido = 0;
    ...
    calcularTotalProducto: function calcularTotalProducto(index) {
      var precio = this.parseCurrency(document.getElementById('precio' + index).value);
    ...
    formatPriceInput: function formatPriceInput(index) {
    ...
    changeCantidad: function changeCantidad(i) {
    ...
    clienteNew: function clienteNew(cliente) {
      // console.log(cliente)
    ...
    guardarFacturaDirecto: function guardarFacturaDirecto() {
      var _this2 = this;
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              _context2.p = 1;
              _this2.pedido.totalPedido = _this2.totalPedido;
              _this2.pedido.pedidos = _this2.pedidos;
              _context2.n = 2;
              return _this2.$emit('guardar', _this2.pedido);
            case 2:
              _context2.n = 4;
              break;
            case 3:
              _context2.p = 3;
              _t = _context2.v;
              console.error('Error al guardar factura directa:', _t);
            case 4:
              _context2.p = 4;
              setTimeout(function () {
    ...
    facturar: function facturar() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var factura, finalizarFactura, _t2;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              _this3.facturaLoading = true;
              _context3.p = 1;
              factura = {
                datos: _this3.datosFactura,
                productos: _this3.pedidos,
                total: _this3.totalPedido
              };
              _context3.n = 2;
              return _this3.ensureModal('invoice', 'finalizarFactura');
            case 2:
              finalizarFactura = _context3.v;
              _context3.n = 3;
              return finalizarFactura.facturar(factura);
            case 3:
              _context3.n = 5;
              break;
            case 4:
              _context3.p = 4;
              _t2 = _context3.v;
              console.error('Error al facturar:', _t2);
            case 5:
              _context3.p = 5;
              // Mantener el loading por un momento para mejor UX
              setTimeout(function () {
                _this3.facturaLoading = false;
              }, 1000);
    ...
    filterItems: function filterItems() {
      var _this4 = this;
      this.items = this.productos.filter(function (producto) {
        return producto.producto.toLowerCase().includes(_this4.nombreProducto.toLowerCase());
      });
    },
    ...
    getPorcentaje: function getPorcentaje() {
      var _this6 = this;
      axios.get('/porcentaje').then(function (res) {
        // console.log(res.data)
        _this6.porcentaje = res.data.porcentaje;
        _this6.getProductos(_this6.tipo_cliente);
      })["catch"](function (err) {
        console.log(err);
      });
    },
    getProductos: function getProductos(tipo_cliente) {
      var _this7 = this;
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              ...
              _context4.p = 1;
              _context4.n = 2;
              return axios.get("/listas-precios/".concat(_this7.pedido.tipolista_id));
            case 2:
              res = _context4.v;
              // console.log(res.data)
              if (tipo_cliente == 1) {
                ...
                for (i = 0; i < res.data.length; i++) {
                  _this7.productos.push({
                    ...
                    precio: Math.round(res.data[i].precio * _this7.porcentaje) + res.data[i].precio
                  });
                }
              } else {
                _this7.productos = res.data;
              }
              _this7.items = _this7.productos;
              _this7.loader = false;
              _context4.n = 4;
              break;
            case 3:
    ...
    getTiposListaPrecios: function getTiposListaPrecios() {
      ...
      axios.get('/tipos-lista-precios').then(function (res) {
        // console.log(res.data);
        _this8.tipoListas = res.data;
      })["catch"](function (err) {
        console.log(err);
      });
    },
    llenarReferencia: function llenarReferencia(nota) {
      // console.log(nota);
    ...
    newCliente: function newCliente() {
      var _this9 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              _context5.n = 1;
              return _this9.ensureModal('client', 'crearCliente');
            case 1:
              crearCliente = _context5.v;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return _this0.ensureModal('product', 'modalProducto');
            case 1:
              modalProducto = _context6.v;
              modalProducto.newProduct(_this0.tipoListas);
            case 2:
    ...
    referenciarFactura: function referenciarFactura() {
      var _this1 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            case 0:
              _context7.n = 1;
              return _this1.ensureModal('pendingInvoices', 'facturas');
            case 1:
              facturas = _context7.v;
              facturas.mostrarModalFacturas(_this1.pedido.cliente_id);
            case 2:
        ...
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            ...
            case 2:
              ...
              try {
                if (_this10.tipo_cliente == 2) {
                  _this10.pedido.num_pedido = document.getElementById('num_pedido').value;
                }
                _this10.pedido.totalPedido = _this10.totalPedido;
                _this10.pedido.pedidos = _this10.pedidos;
                _this10.$emit('guardar', _objectSpread(_objectSpread({}, _this10.pedido), {}, {
                  pedidos: _this10.pedidos,
                  totalPedido: _this10.totalPedido
                }));
              } catch (error) {
    ...
    selectCliente: function selectCliente(item) {
      if (item) {
    ...
    setPedidos: function setPedidos() {
      ...
      if (this.datosFactura.code === 2) {
        ...
        for (var i = 0; i < this.datosFactura.productos.length; i++) {
          this.pedidos.push({
    ...
    setVentas: function setVentas(pedidos, cliente) {
      this.pedidos = pedidos;
      this.selectCliente(cliente);
      this.calculaTotalPedido();
      this.esFacturaDirecto = true;
    },
    setTransferencia: function setTransferencia(pedidos, cliente) {
      this.pedidos = pedidos;
      this.selectCliente(cliente);
      this.calculaTotalPedido();
    },
    ...
    viewHistory: function viewHistory(item) {
      var _this11 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var historyPrice, _t4;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              // Activar el loader para este item específico
              _this11.$set(_this11.historyLoading, item.codigo, true);
              _context9.p = 1;
              _context9.n = 2;
              return _this11.ensureModal('history', 'historyPrice');
            case 2:
              historyPrice = _context9.v;
              _context9.n = 3;
              return historyPrice.showPriceProducts(item);
            case 3:
              _context9.n = 5;
              break;
            case 4:
              _context9.p = 4;
              _t4 = _context9.v;
              console.error('Error al cargar historial:', _t4);
            case 5:
              _context9.p = 5;
              // Desactivar el loader después de un pequeño delay para mejor UX
              setTimeout(function () {
                _this11.$set(_this11.historyLoading, item.codigo, false);
              }, 500);
  ...
  computed: {
    formatTotal: function formatTotal() {
      var options2 = {
        style: "currency",
        currency: "USD"
      };
      var formateo = new Intl.NumberFormat("en-US", options2);
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n/* Estilos para productos */\n.products-grid[data-v-bf42bc70] {\r\n    background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);\r\n    border-radius: 12px;\r\n    padding: 15px;\r\n    height: 520px;\r\n    max-height: 520px;\r\n    overflow-x: hidden;\r\n    overflow-y: auto;\r\n    scrollbar-gutter: stable;\r\n    -webkit-overflow-scrolling: touch;\n}\n.product-card[data-v-bf42bc70] {\r\n    background: linear-gradient(145deg, #ffffff 0%, #f8f9fa 100%);\r\n    border-radius: 16px;\r\n    box-shadow: 0 8px 25px rgba(0,0,0,0.08), 0 4px 10px rgba(0,0,0,0.03);\r\n    border: 1px solid rgba(255,255,255,0.8);\r\n    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);\r\n    height: 100%;\r\n    min-height: 0;\r\n    position: relative;\r\n    overflow: hidden;\n}\n.product-card[data-v-bf42bc70]::before {\r\n    content: '';\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    right: 0;\r\n    height: 4px;\r\n    background: linear-gradient(90deg, #17a2b8 0%, #138496 50%, #f093fb 100%);\r\n    opacity: 0;\r\n    transition: opacity 0.3s;\n}\n.product-card[data-v-bf42bc70]:hover {\r\n    box-shadow: 0 20px 40px rgba(0,0,0,0.12), 0 8px 16px rgba(0,0,0,0.06);\r\n    transform: translateY(-8px) scale(1.02);\r\n    border-color: rgba(102, 126, 234, 0.3);\n}\n.product-card[data-v-bf42bc70]:hover::before {\r\n    opacity: 1;\n}\n.product-logo[data-v-bf42bc70] {\r\n    display: block;\r\n    margin: 0 auto 6px;\r\n    padding: 2px;\r\n    background: transparent;\r\n    border-radius: 8px;\r\n    width: 38px;\r\n    height: 38px;\r\n    -o-object-fit: contain;\r\n       object-fit: contain;\n}\n.product-title[data-v-bf42bc70] {\r\n    font-size: 0.9rem;\r\n    font-weight: 700;\r\n    color: #2c3e50;\r\n    line-height: 1.3;\r\n    margin-bottom: 8px;\r\n    text-align: center;\r\n    min-height: 34px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\n}\n.badge-sm[data-v-bf42bc70] {\r\n    font-size: 0.75rem;\r\n    padding: 0.3em 0.65em;\r\n    border-radius: 20px;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    border: none;\r\n    color: white;\r\n    font-weight: 600;\r\n    box-shadow: 0 2px 8px rgba(23, 162, 184, 0.3);\n}\n.history-btn[data-v-bf42bc70] {\r\n    color: #17a2b8;\r\n    font-size: 1rem;\r\n    cursor: pointer;\r\n    transition: all 0.3s;\r\n    padding: 5px;\r\n    border-radius: 50%;\r\n    background: rgba(102, 126, 234, 0.1);\r\n    display: inline-flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    width: 28px;\r\n    height: 28px;\n}\n.history-btn[data-v-bf42bc70]:hover {\r\n    color: #5a67d8;\r\n    background: rgba(102, 126, 234, 0.2);\r\n    transform: scale(1.1);\n}\n.history-btn.loading[data-v-bf42bc70] {\r\n    background: rgba(23, 162, 184, 0.2);\r\n    cursor: default;\r\n    pointer-events: none;\n}\n.mini-spinner[data-v-bf42bc70] {\r\n    width: 16px;\r\n    height: 16px;\r\n    border: 2px solid rgba(23, 162, 184, 0.3);\r\n    border-left: 2px solid #17a2b8;\r\n    border-radius: 50%;\r\n    animation: miniSpin-bf42bc70 1s linear infinite;\r\n    margin: 0 auto;\n}\n@keyframes miniSpin-bf42bc70 {\n0% { transform: rotate(0deg);\n}\n100% { transform: rotate(360deg);\n}\n}\r\n\r\n/* Save Button Loading Spinner */\n.save-spinner[data-v-bf42bc70] {\r\n    width: 18px;\r\n    height: 18px;\r\n    border: 2px solid rgba(255, 255, 255, 0.3);\r\n    border-left: 2px solid #ffffff;\r\n    border-radius: 50%;\r\n    animation: saveSpinAnimation-bf42bc70 1s linear infinite;\r\n    display: inline-block;\n}\n@keyframes saveSpinAnimation-bf42bc70 {\n0% { transform: rotate(0deg);\n}\n100% { transform: rotate(360deg);\n}\n}\r\n\r\n/* Button loading states */\n.btn[data-v-bf42bc70]:disabled {\r\n    opacity: 0.8;\r\n    cursor: not-allowed;\r\n    pointer-events: none;\n}\n.btn.btn-primary[data-v-bf42bc70]:disabled {\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    border-color: #17a2b8;\n}\n.btn.btn-success[data-v-bf42bc70]:disabled {\r\n    background: linear-gradient(135deg, #28a745 0%, #20c997 100%);\r\n    border-color: #28a745;\n}\n.btn.btn-secondary[data-v-bf42bc70]:disabled {\r\n    background: #6c757d;\r\n    border-color: #6c757d;\n}\n.product-info[data-v-bf42bc70] {\r\n    text-align: center;\r\n    background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);\r\n    border-radius: 12px;\r\n    padding: 7px 6px;\r\n    margin: 4px 0;\n}\n.stock-info[data-v-bf42bc70] {\r\n    font-size: 0.85rem;\r\n    font-weight: 700;\r\n    display: block;\r\n    margin-bottom: 3px;\r\n    text-transform: uppercase;\r\n    letter-spacing: 0.5px;\n}\n.price-info[data-v-bf42bc70] {\r\n    font-size: 1rem;\r\n    font-weight: 800;\r\n    color: #2c3e50;\r\n    background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%);\r\n    border-radius: 8px;\r\n    padding: 4px 8px;\r\n    display: inline-block;\r\n    box-shadow: 0 2px 8px rgba(252, 182, 159, 0.3);\n}\r\n\r\n/* Estilos para la tabla compacta */\n.order-card[data-v-bf42bc70] {\r\n    box-shadow: 0 4px 8px rgba(0,0,0,0.1);\r\n    border: none;\n}\n.order-form[data-v-bf42bc70] {\r\n    margin-right: -7px;\r\n    margin-left: -7px;\r\n    row-gap: 14px;\n}\n.order-form .form-field[data-v-bf42bc70] {\r\n    padding-right: 7px;\r\n    padding-left: 7px;\n}\n.reference-fields[data-v-bf42bc70] {\r\n    margin: 14px -7px 0;\r\n    row-gap: 14px;\n}\n.reference-fields .reference-field[data-v-bf42bc70] {\r\n    padding-right: 7px;\r\n    padding-left: 7px;\n}\n.form-field-label[data-v-bf42bc70] {\r\n    display: block;\r\n    margin-bottom: 6px;\r\n    color: #475569;\r\n    font-size: 0.78rem;\r\n    font-weight: 700;\r\n    letter-spacing: 0.025em;\n}\n.order-form-control[data-v-bf42bc70] {\r\n    height: 46px;\r\n    padding-right: 2.5rem;\r\n    padding-left: 0.9rem;\r\n    color: #334155;\r\n    background-color: #fff;\r\n    border: 1px solid #d7dee8;\r\n    border-radius: 10px;\r\n    box-shadow: 0 2px 6px rgba(15, 23, 42, 0.04);\r\n    font-family: inherit;\r\n    font-size: 0.9rem;\r\n    line-height: 1.2;\r\n    transition: border-color 0.2s, box-shadow 0.2s;\n}\n.order-form-control[data-v-bf42bc70]:focus {\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.14);\n}\n.client-select[data-v-bf42bc70] .ui.selection.dropdown {\r\n    display: flex;\r\n    align-items: center;\r\n    width: 100%;\r\n    min-width: 0;\r\n    min-height: 46px;\r\n    padding: 0.75rem 2.5rem 0.75rem 0.9rem;\r\n    color: #334155;\r\n    border: 1px solid #d7dee8;\r\n    border-radius: 10px;\r\n    box-shadow: 0 2px 6px rgba(15, 23, 42, 0.04);\r\n    font-family: inherit;\r\n    font-size: 0.9rem;\r\n    line-height: 1.2;\r\n    transition: border-color 0.2s, box-shadow 0.2s;\n}\n.client-select[data-v-bf42bc70] .ui.selection.dropdown > .text,\r\n.client-select[data-v-bf42bc70] .ui.search.dropdown > input.search {\r\n    font-family: inherit;\r\n    font-size: 0.9rem;\n}\n.client-select[data-v-bf42bc70] .ui.selection.dropdown:focus,\r\n.client-select[data-v-bf42bc70] .ui.selection.active.dropdown {\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.14);\n}\n.form-action[data-v-bf42bc70] {\r\n    display: flex;\r\n    align-items: flex-end;\n}\n.order-action-btn[data-v-bf42bc70] {\r\n    display: inline-flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    gap: 9px;\r\n    min-height: 46px;\r\n    border-radius: 10px;\r\n    font-family: inherit;\r\n    font-size: 0.9rem;\r\n    font-weight: 700;\r\n    transition: transform 0.2s, box-shadow 0.2s, background-color 0.2s;\n}\n.new-client-btn[data-v-bf42bc70] {\r\n    color: #fff;\r\n    background: linear-gradient(135deg, #20b486 0%, #169b76 100%);\r\n    border: 1px solid #169b76;\r\n    box-shadow: 0 5px 12px rgba(22, 155, 118, 0.2);\n}\n.new-client-btn[data-v-bf42bc70]:hover,\r\n.new-client-btn[data-v-bf42bc70]:focus {\r\n    color: #fff;\r\n    background: linear-gradient(135deg, #1ca379 0%, #128363 100%);\r\n    box-shadow: 0 7px 16px rgba(22, 155, 118, 0.28);\r\n    transform: translateY(-1px);\n}\n.table-compact[data-v-bf42bc70] {\r\n    margin-bottom: 0;\r\n    font-size: 0.85rem;\n}\n.order-items-scroll[data-v-bf42bc70] {\r\n    width: 100%;\r\n    max-height: clamp(220px, 38vh, 380px);\r\n    overflow-x: auto;\r\n    overflow-y: scroll;\r\n    overscroll-behavior: contain;\r\n    scrollbar-gutter: stable;\r\n    -webkit-overflow-scrolling: touch;\r\n    border-bottom: 1px solid #dee2e6;\n}\n.order-items-scroll .table-compact[data-v-bf42bc70] {\r\n    min-width: 680px;\n}\n.order-items-scroll .table-compact thead th[data-v-bf42bc70] {\r\n    background: #f8f9fa;\r\n    box-shadow: inset 0 -1px 0 #dee2e6;\n}\n.table-compact th[data-v-bf42bc70],\r\n.table-compact td[data-v-bf42bc70] {\r\n    padding: 0.4rem 0.5rem;\r\n    vertical-align: middle;\r\n    border-top: 1px solid #dee2e6;\n}\n.compact-header[data-v-bf42bc70] {\r\n    background: #f8f9fa;\r\n    color: #495057;\n}\n.compact-th[data-v-bf42bc70] {\r\n    font-size: 0.8rem;\r\n    font-weight: 600;\r\n    padding: 0.5rem 0.4rem;\r\n    border: none;\r\n    text-align: center;\n}\n.compact-row[data-v-bf42bc70] {\r\n    transition: background-color 0.2s;\r\n    height: 38px;\n}\n.compact-row[data-v-bf42bc70]:hover {\r\n    background-color: #f8f9fa;\n}\n.compact-cell[data-v-bf42bc70] {\r\n    padding: 0.3rem 0.4rem;\r\n    vertical-align: middle;\r\n    font-size: 0.82rem;\r\n    height: 38px;\n}\n.product-cell[data-v-bf42bc70] {\r\n    width: 35%;\r\n    max-width: 200px;\r\n    text-align: left;\r\n    padding-right: 8px;\n}\n.product-name[data-v-bf42bc70] {\r\n    font-size: 0.8rem;\r\n    font-weight: 500;\r\n    color: #495057;\r\n    line-height: 1.2;\r\n    display: block;\r\n    word-wrap: break-word;\r\n    overflow-wrap: break-word;\r\n    hyphens: auto;\n}\n.total-cell[data-v-bf42bc70] {\r\n    width: 15%;\r\n    min-width: 90px;\n}\n.compact-input[data-v-bf42bc70] {\r\n    width: 100%;\r\n    height: 28px;\r\n    padding: 0.25rem 0.4rem;\r\n    font-size: 0.8rem;\r\n    border: 1px solid #ced4da;\r\n    border-radius: 4px;\r\n    text-align: center;\r\n    background: white;\r\n    transition: border-color 0.2s, box-shadow 0.2s;\n}\n.compact-input[data-v-bf42bc70]:focus {\r\n    border-color: #80bdff;\r\n    box-shadow: 0 0 0 2px rgba(0,123,255,0.25);\r\n    outline: none;\n}\n.precio-input[data-v-bf42bc70] {\r\n    background: #f1f3f4;\r\n    border-color: #d1d5db;\r\n    font-weight: 600;\r\n    width: 100%;\r\n    min-width: 80px;\r\n    text-align: center;\n}\n.precio-input[data-v-bf42bc70]:focus {\r\n    background: #e5e7eb;\r\n    border-color: #9ca3af;\n}\n.cantidad-input[data-v-bf42bc70] {\r\n    background: #f1f3f4;\r\n    border-color: #d1d5db;\r\n    font-weight: 600;\r\n    width: 100%;\r\n    min-width: 50px;\r\n    text-align: center;\n}\n.cantidad-input[data-v-bf42bc70]:focus {\r\n    background: #e5e7eb;\r\n    border-color: #9ca3af;\n}\n.total-value[data-v-bf42bc70] {\r\n    font-weight: 700;\r\n    color: #28a745;\r\n    font-size: 0.85rem;\r\n    white-space: nowrap;\r\n    display: inline-block;\r\n    background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%);\r\n    padding: 2px 6px;\r\n    border-radius: 6px;\r\n    border: 1px solid rgba(40, 167, 69, 0.2);\n}\n.delete-btn[data-v-bf42bc70] {\r\n    cursor: pointer;\r\n    font-size: 0.85rem;\r\n    padding: 0.2rem;\r\n    transition: color 0.2s;\n}\n.delete-btn[data-v-bf42bc70]:hover {\r\n    color: #dc3545 !important;\r\n    transform: scale(1.1);\n}\r\n\r\n/* Responsivo */\n@media (max-width: 920px) {\n.catalog-panel[data-v-bf42bc70],\r\n    .order-panel[data-v-bf42bc70],\r\n    .product-search-field[data-v-bf42bc70],\r\n    .product-create-action[data-v-bf42bc70] {\r\n        flex: 0 0 100%;\r\n        max-width: 100%;\n}\n.product-create-action[data-v-bf42bc70] {\r\n        margin-top: 0.5rem;\n}\n.order-panel[data-v-bf42bc70] {\r\n        margin-top: 1rem;\n}\n.product-card[data-v-bf42bc70] {\r\n        min-height: 160px;\n}\n.order-form[data-v-bf42bc70] {\r\n        row-gap: 12px;\n}\n.reference-fields[data-v-bf42bc70] {\r\n        row-gap: 12px;\n}\n.compact-input[data-v-bf42bc70] {\r\n        height: 32px;\r\n        font-size: 0.85rem;\n}\n.compact-cell[data-v-bf42bc70] {\r\n        padding: 0.4rem 0.3rem;\r\n        height: 42px;\n}\n.product-name[data-v-bf42bc70] {\r\n        font-size: 0.75rem;\n}\n}\r\n\r\n/* Professional Loading Styles */\n.loading-container[data-v-bf42bc70] {\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    min-height: 400px;\r\n    padding: 40px 20px;\r\n    background: linear-gradient(135deg, #17a2b820 0%, #13849620 100%);\r\n    border-radius: 12px;\r\n    backdrop-filter: blur(10px);\r\n    border: 1px solid rgba(255, 255, 255, 0.3);\n}\n.loading-content[data-v-bf42bc70] {\r\n    text-align: center;\r\n    max-width: 300px;\n}\n.professional-loader[data-v-bf42bc70] {\r\n    position: relative;\r\n    display: inline-block;\r\n    margin-bottom: 30px;\n}\n.loader-spinner[data-v-bf42bc70] {\r\n    width: 60px;\r\n    height: 60px;\r\n    border: 4px solid rgba(102, 126, 234, 0.1);\r\n    border-left: 4px solid #17a2b8;\r\n    border-radius: 50%;\r\n    animation: spin-bf42bc70 1s linear infinite;\r\n    position: relative;\r\n    z-index: 2;\n}\n.loader-pulse[data-v-bf42bc70] {\r\n    position: absolute;\r\n    top: -10px;\r\n    left: -10px;\r\n    width: 80px;\r\n    height: 80px;\r\n    border: 2px solid rgba(102, 126, 234, 0.3);\r\n    border-radius: 50%;\r\n    animation: pulse-bf42bc70 2s ease-in-out infinite;\r\n    z-index: 1;\n}\n@keyframes spin-bf42bc70 {\n0% { transform: rotate(0deg);\n}\n100% { transform: rotate(360deg);\n}\n}\n@keyframes pulse-bf42bc70 {\n0% {\r\n        transform: scale(0.8);\r\n        opacity: 1;\n}\n50% {\r\n        transform: scale(1.2);\r\n        opacity: 0.5;\n}\n100% {\r\n        transform: scale(0.8);\r\n        opacity: 1;\n}\n}\n.loading-text[data-v-bf42bc70] {\r\n    margin-bottom: 25px;\n}\n.loading-title[data-v-bf42bc70] {\r\n    color: #2c3e50;\r\n    font-size: 1.4rem;\r\n    font-weight: 700;\r\n    margin-bottom: 8px;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    background-clip: text;\r\n    -webkit-background-clip: text;\r\n    -webkit-text-fill-color: transparent;\n}\n.loading-subtitle[data-v-bf42bc70] {\r\n    color: #6c757d;\r\n    font-size: 0.95rem;\r\n    font-weight: 400;\r\n    margin: 0;\r\n    line-height: 1.4;\n}\n.loading-dots[data-v-bf42bc70] {\r\n    display: flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n    gap: 8px;\n}\n.dot[data-v-bf42bc70] {\r\n    width: 8px;\r\n    height: 8px;\r\n    border-radius: 50%;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    animation: dotBounce-bf42bc70 1.4s ease-in-out infinite both;\n}\n.dot-1[data-v-bf42bc70] {\r\n    animation-delay: -0.32s;\n}\n.dot-2[data-v-bf42bc70] {\r\n    animation-delay: -0.16s;\n}\n.dot-3[data-v-bf42bc70] {\r\n    animation-delay: 0s;\n}\n@keyframes dotBounce-bf42bc70 {\n0%, 80%, 100% {\r\n        transform: scale(0.6);\r\n        opacity: 0.5;\n}\n40% {\r\n        transform: scale(1);\r\n        opacity: 1;\n}\n}\r\n\r\n/* Loading hover effect */\n.loading-container:hover .loader-spinner[data-v-bf42bc70] {\r\n    border-left-color: #5a67d8;\r\n    animation-duration: 0.8s;\n}\n.loading-container:hover .loader-pulse[data-v-bf42bc70] {\r\n    border-color: rgba(90, 103, 216, 0.4);\r\n    animation-duration: 1.5s;\n}\r\n\r\n/* Responsive loading */\n@media (max-width: 920px) {\n.loading-container[data-v-bf42bc70] {\r\n        min-height: 300px;\r\n        padding: 30px 15px;\n}\n.loader-spinner[data-v-bf42bc70] {\r\n        width: 50px;\r\n        height: 50px;\n}\n.loader-pulse[data-v-bf42bc70] {\r\n        width: 70px;\r\n        height: 70px;\r\n        top: -10px;\r\n        left: -10px;\n}\n.loading-title[data-v-bf42bc70] {\r\n        font-size: 1.2rem;\n}\n.loading-subtitle[data-v-bf42bc70] {\r\n        font-size: 0.9rem;\n}\n}\r\n\r\n/* Ajustes específicos para el layout */\n.row[data-v-bf42bc70] {\r\n    margin-left: -10px;\r\n    margin-right: -10px;\n}\n.row > [class*=\"col-\"][data-v-bf42bc70] {\r\n    padding-left: 10px;\r\n    padding-right: 10px;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_style_index_0_id_bf42bc70_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_style_index_0_id_bf42bc70_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", [_vm.mountedModals.history ? _c("view-history-price", {
    ref: "historyPrice"
  }) : _vm._e(), _vm._v(" "), _vm.mountedModals.client ? _c("crear-cliente", {
    ref: "crearCliente",
    on: {
      cliente_id: _vm.clienteNew
    }
  }) : _vm._e(), _vm._v(" "), _vm.mountedModals.invoice ? _c("informacion-final-facturas", {
    ref: "finalizarFactura"
  }) : _vm._e(), _vm._v(" "), _vm.mountedModals.product ? _c("modalitem-component", {
    ref: "modalProducto",
    on: {
      updateItems: _vm.updateListItems
    }
  }) : _vm._e(), _vm._v(" "), _vm.mountedModals.pendingInvoices ? _c("modalfacturas-pendientes", {
    ref: "facturas",
    on: {
      seleccionar: _vm.llenarReferencia
    }
  }) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-md-5 col-sm-12 catalog-panel"
  }, [_c("div", {
    staticClass: "row p-2 mb-1"
  }, [_c("div", {
    staticClass: "col-12 col-md-8 product-search-field"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "col-12 col-md-4 product-create-action"
  }, [_c("button", {
    staticClass: "btn btn-outline-primary btn-sm btn-block text-wrap",
    on: {
    ...
    return _c("div", {
      key: index,
      staticClass: "col-6 col-lg-4 mb-2"
    }, [_c("div", {
      staticClass: "product-card p-2"
    }, [_c("img", {
      ...
      staticClass: "product-title mb-1"
    }, [_vm._v(" " + _vm._s(item.producto))]), _vm._v(" "), _c("div", {
      staticClass: "text-center mb-1"
    }, [_c("span", {
      staticClass: "badge badge-info badge-sm text-wrap"
    }, [_vm._v(" " + _vm._s(item.presentacion) + " ")])]), _vm._v(" "), _c("div", {
      staticClass: "text-center mb-1"
    }, [_vm.historyLoading[item.codigo] ? _c("div", {
      staticClass: "history-btn loading"
    }, [_c("div", {
      staticClass: "mini-spinner"
    })]) : _c("i", {
      staticClass: "fas fa-search history-btn",
      attrs: {
        role: "button"
      },
      on: {
      ...
      on: {
        click: function click($event) {
          return _vm.addProducto(item, index);
        }
      }
    }, [_c("span", {
      staticClass: "stock-info",
      "class": [item.stock > 0 ? "text-success" : "text-danger"]
    }, [_vm._v("Cant. " + _vm._s(item.stock))]), _vm._v(" "), _c("br"), _vm._v(" "), _c("span", {
      staticClass: "price-info"
    }, [_vm._v(_vm._s(_vm._f("currency")(item.precio)))])])])]);
  }), 0)])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-7 col-sm-12 order-panel"
  }, [_c("div", {
    staticClass: "card order-card"
  }, [_c("div", {
    ...
    staticClass: "row"
  }, [_vm.esFactura ? _c("div", {
    staticClass: "col-12"
  }, [_vm.datosFactura.code === 1 ? _c("b-alert", {
    attrs: {
      show: "",
      variant: "info"
    }
  }, [_vm._v("No existen acciones pendientes por realizar.")]) : _vm._e()], 1) : _vm._e()]), _vm._v(" "), _vm._t("opcionesExtras"), _vm._v(" "), _c("div", {
    staticClass: "row order-form"
  }, [_c("div", {
  ...
  }, [_vm._v("Lista de precios")]), _vm._v(" "), _c("b-form-select", {
    staticClass: "order-form-control",
    attrs: {
      id: "tipolista_id",
      options: _vm.tipoListas,
      "value-field": "id",
      "text-field": "tipo_lista"
    },
    on: {
      change: function change($event) {
        return _vm.getProductos(_vm.tipo_cliente);
      }
    },
    model: {
      value: _vm.pedido.tipolista_id,
      callback: function callback($$v) {
        _vm.$set(_vm.pedido, "tipolista_id", $$v);
      },
      expression: "pedido.tipolista_id"
    }
  })], 1), _vm._v(" "), _c("div", {
    staticClass: "col-12 col-lg-8 col-md-12 form-field"
  }, [_c("label", {
    staticClass: "form-field-label",
    attrs: {
      "for": "cliente"
    ...
    staticClass: "client-select"
  }, [_c("basic-select", {
    attrs: {
      options: _vm.clientes,
      id: "cliente",
      placeholder: "Buscar cliente",
      "selected-option": _vm.itemCliente
    },
    on: {
      select: _vm.selectCliente
    },
    model: {
      value: _vm.pedido.cliente_id,
      callback: function callback($$v) {
        _vm.$set(_vm.pedido, "cliente_id", $$v);
      },
      expression: "pedido.cliente_id"
    }
  })], 1)]), _vm._v(" "), _vm.esNota ? _c("div", {
    staticClass: "col-12 col-lg-4 col-md-12 form-field form-action"
  }, [_c("button", {
    staticClass: "btn btn-outline-success btn-block text-small text-wrap order-action-btn",
    on: {
      click: _vm.referenciarFactura
    }
  }, [_c("i", {
    ...
    staticClass: "btn btn-block text-small text-wrap order-action-btn new-client-btn",
    on: {
      click: _vm.newCliente
    }
  }, [_c("i", {
    staticClass: "fas fa-user-plus"
  }), _vm._v(" "), _c("span", [_vm._v("Nuevo cliente")])])])]), _vm._v(" "), _c("div", {
    staticClass: "order-items-scroll mb-2"
  }, [_c("table", {
    staticClass: "table table-sm table-compact mb-0"
  }, [_vm._m(1), _vm._v(" "), _c("tbody", _vm._l(_vm.pedidos, function (item, index) {
    return _c("tr", {
      key: index,
      staticClass: "compact-row",
      attrs: {
        id: "row-" + item.codigo
      }
    }, [_c("td", {
      staticClass: "compact-cell product-cell"
    }, [_c("span", {
      staticClass: "product-name"
    }, [_vm._v(_vm._s(item.producto.toLowerCase()))])]), _vm._v(" "), _c("td", {
      staticClass: "compact-cell text-center"
    }, [_c("input", {
      staticClass: "compact-input precio-input",
      attrs: {
        type: "text",
        id: "precio" + index
      },
      domProps: {
        value: _vm.formatCurrency(item.precio)
      },
      on: {
        blur: function blur($event) {
          return _vm.calcularTotalProducto(index);
        },
        input: function input($event) {
          return _vm.formatPriceInput(index);
        }
      }
    })]), _vm._v(" "), _c("td", {
      staticClass: "compact-cell text-center"
    }, [_c("input", {
      staticClass: "compact-input cantidad-input",
      attrs: {
        type: "number",
        id: "cantidad" + index
      },
      ...
      on: {
        input: function input($event) {
          return _vm.addBonus(index);
        }
      }
    })]), _vm._v(" "), _c("td", {
      staticClass: "compact-cell text-center total-cell"
    }, [_c("span", {
      staticClass: "total-value"
    }, [_vm._v(_vm._s(_vm._f("currency")(item.total)))])]), _vm._v(" "), _c("td", {
      staticClass: "compact-cell text-center"
    }, [_c("i", {
      staticClass: "fas fa-trash text-danger delete-btn",
      attrs: {
        role: "button"
      },
      on: {
  ...
  }), 0)])]), _vm._v(" "), _vm.esNota ? _c("div", {
    staticClass: "row reference-fields"
  }, [_c("div", {
    staticClass: "col-12 col-md-6 reference-field"
  }, [_c("label", {
    staticClass: "form-field-label",
    attrs: {
      "for": "numero_referencia"
    }
  }, [_vm._v("No. referencia")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.pedido.numero_referencia,
      expression: "pedido.numero_referencia"
    }],
    staticClass: "form-control order-form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.pedido, "numero_referencia", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "col-12 col-md-6 reference-field"
    ...
    staticClass: "form-field-label",
    attrs: {
      "for": "fecha_referencia"
    }
  }, [_vm._v("Fecha de referencia")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.pedido.fecha_referencia,
      expression: "pedido.fecha_referencia"
    }],
    staticClass: "form-control order-form-control",
    attrs: {
      type: "date",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.pedido, "fecha_referencia", $event.target.value);
      }
    }
  })]), _vm._v(" "), _vm.pedido.id_factura ? _c("div", {
    staticClass: "col-12"
  }, [_c("a", {
    attrs: {
      href: "/imprimir-factura/" + _vm.pedido.id_factura,
      target: "_blank"
    }
  }, [_vm._v("Representación grafica - saldo factura (" + _vm._s(_vm._f("currency")(_vm.pedido.valor_max_nota)) + ") "), _c("i", {
    staticClass: "fas fa-file-pdf"
  })])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "col-12 reference-field"
  }, [_c("label", {
    staticClass: "form-field-label",
    attrs: {
      "for": "razon_referencia"
    }
  }, [_vm._v("Razón de la referencia")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.pedido.razon_referencia,
      expression: "pedido.razon_referencia"
    }],
    staticClass: "form-control order-form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.pedido, "razon_referencia", $event.target.value);
      }
    }
  })])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "d-flex justify-content-between my-2 p-1 bg-info rounded"
  }, [_c("div", [_vm._v("\n                            Items: " + _vm._s(this.pedidos.length) + "\n                        ")]), _vm._v(" "), !_vm.esNota ? _c("div", [_vm._v("\n                            Total: " + _vm._s(_vm._f("currency")(_vm.totalPedido)) + "\n                        ")]) : _c("div", [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.pedido.valor_nota,
      expression: "pedido.valor_nota"
    }],
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.pedido, "valor_nota", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _vm.esFactura ? _c("div", {
    staticClass: "row"
  }, [_vm.datosFactura.code !== 1 ? _c("div", {
    staticClass: "col-12"
  }, [_c("button", {
    staticClass: "btn btn-primary btn-block",
    attrs: {
      disabled: _vm.facturaLoading
    },
    on: {
      click: _vm.facturar
    }
  }, [_vm.facturaLoading ? _c("div", {
    staticClass: "d-flex align-items-center justify-content-center"
  }, [_c("div", {
    staticClass: "save-spinner mr-2"
  }), _vm._v("\n                                    Procesando...\n                                ")]) : _c("div", [_c("i", {
    staticClass: "fas fa-file mr-2"
  }), _vm._v("Facturar\n                                ")])])]) : _vm._e()]) : _vm._e(), _vm._v(" "), !_vm.esFactura && !_vm.esFacturaDirecto ? _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-6"
  }, [_c("button", {
  ...
  }, [_vm.saveLoading ? _c("div", {
    staticClass: "d-flex align-items-center justify-content-center"
  }, [_c("div", {
    staticClass: "save-spinner mr-2"
  }), _vm._v("\n                                    Guardando...\n                                ")]) : _c("div", [_c("i", {
    staticClass: "fas fa-save mr-2"
  }), _vm._v("Guardar\n                                ")])])])]) : _vm._e(), _vm._v(" "), _vm.esFacturaDirecto ? _c("div", {
    staticClass: "row"
  }, [_vm._t("checkEsFactura"), _vm._v(" "), _c("div", {
    staticClass: "col-12"
  }, [_c("button", {
    ...
    on: {
      click: _vm.guardarFacturaDirecto
    }
  }, [_vm.saveLoading ? _c("div", {
    staticClass: "d-flex align-items-center justify-content-center"
  }, [_c("div", {
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Por favor espera mientras obtenemos la información")])]), _vm._v(" "), _c("div", {
  ...
  return _c("thead", {
    ...
    staticClass: "compact-header"
  }, [_c("th", {
    staticClass: "compact-th",
    staticStyle: {
      width: "35%"
    }
  }, [_vm._v("Item")]), _vm._v(" "), _c("th", {
    staticClass: "compact-th text-center",
    staticStyle: {
      width: "20%"
    }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true */ "./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true");
/* harmony import */ var _ItemsComponent_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ItemsComponent.vue?vue&type=script&lang=js */ "./resources/js/components/ItemsComponent.vue?vue&type=script&lang=js");
/* harmony import */ var _ItemsComponent_vue_vue_type_style_index_0_id_bf42bc70_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css */ "./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ItemsComponent_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "bf42bc70",
  null
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ItemsComponent.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css":
/*!************************************************************************************************************!*\
  !*** ./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_style_index_0_id_bf42bc70_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=style&index=0&id=bf42bc70&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ItemsComponent_vue_vue_type_template_id_bf42bc70_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ItemsComponent.vue?vue&type=template&id=bf42bc70&scoped=true");
