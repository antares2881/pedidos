(self["webpackChunk"] = self["webpackChunk"] || []).push([["screen-User-vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    filteredUsuarios: function filteredUsuarios() {
      var _this = this;
      var filtered = this.usuarios;

      // Aplicar filtro de búsqueda
      if (this.search) {
        filtered = filtered.filter(function (usuario) {
          return usuario.email.toLowerCase().includes(_this.search.toLowerCase()) || usuario.name.toLowerCase().includes(_this.search.toLowerCase());
        });
      }
      return filtered;
    },
    paginatedUsuarios: function paginatedUsuarios() {
    ...
    paginationInfo: function paginationInfo() {
      ...
      var end = Math.min(this.currentPage * this.itemsPerPage, this.filteredUsuarios.length);
      return {
        start: start,
        end: end,
  ...
  methods: {
    ...
    save: function save() {
      var _this5 = this;
      axios.post('/usuarios', this.user).then(function (res) {
        if (res.data === 'ok') {
          Swal.fire({
            icon: 'success',
          ...
          _this5.erroresUser = res.data.errors || res.data || {};
        }
      })["catch"](function (err) {
        if (err.response && err.response.status === 422) {
          _this5.erroresUser = err.response.data.errors || {};
        } else {
          console.log(err);
        }
      });
    ...
    updateUser: function updateUser() {
      var _this6 = this;
      axios.put("/usuarios/".concat(this.user.id), this.user).then(function (res) {
        if (res.data === 'ok') {
          Object.assign(_this6.usuarios[_this6.index], _this6.user);
          _this6.close();
        } else {
          _this6.erroresUser = res.data.errors || res.data || {};
        }
      })["catch"](function (err) {
        if (err.response && err.response.status === 422) {
          _this6.erroresUser = err.response.data.errors || {};
        } else {
          console.log(err);
        }
      });
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n/* Professional Container */\n.users-container[data-v-d884f594] {\r\n    min-height: 100vh;\r\n    background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);\r\n    padding: 2rem;\n}\r\n\r\n/* Professional Loading */\n.loading-container[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    min-height: 400px;\r\n    padding: 40px 20px;\r\n    background: linear-gradient(135deg, #17a2b820 0%, #13849620 100%);\r\n    border-radius: 12px;\r\n    backdrop-filter: blur(10px);\r\n    border: 1px solid rgba(255, 255, 255, 0.3);\n}\n.loading-content[data-v-d884f594] {\r\n    text-align: center;\r\n    max-width: 300px;\n}\n.professional-loader[data-v-d884f594] {\r\n    position: relative;\r\n    display: inline-block;\r\n    margin-bottom: 30px;\n}\n.loader-spinner[data-v-d884f594] {\r\n    width: 60px;\r\n    height: 60px;\r\n    border: 4px solid rgba(102, 126, 234, 0.1);\r\n    border-left: 4px solid #17a2b8;\r\n    border-radius: 50%;\r\n    animation: spin-d884f594 1s linear infinite;\r\n    position: relative;\r\n    z-index: 2;\n}\n.loader-pulse[data-v-d884f594] {\r\n    position: absolute;\r\n    top: -10px;\r\n    left: -10px;\r\n    width: 80px;\r\n    height: 80px;\r\n    border: 2px solid rgba(102, 126, 234, 0.3);\r\n    border-radius: 50%;\r\n    animation: pulse-d884f594 2s ease-in-out infinite;\r\n    z-index: 1;\n}\n@keyframes spin-d884f594 {\n0% { transform: rotate(0deg);\n}\n100% { transform: rotate(360deg);\n}\n}\n@keyframes pulse-d884f594 {\n0% { transform: scale(0.8); opacity: 1;\n}\n50% { transform: scale(1.2); opacity: 0.5;\n}\n100% { transform: scale(0.8); opacity: 1;\n}\n}\n.loading-title[data-v-d884f594] {\r\n    color: #2c3e50;\r\n    font-size: 1.4rem;\r\n    font-weight: 700;\r\n    margin-bottom: 8px;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    background-clip: text;\r\n    -webkit-background-clip: text;\r\n    -webkit-text-fill-color: transparent;\n}\n.loading-subtitle[data-v-d884f594] {\r\n    color: #6c757d;\r\n    font-size: 0.95rem;\r\n    font-weight: 400;\r\n    margin: 0;\r\n    line-height: 1.4;\n}\r\n\r\n/* Header Section */\n.users-content[data-v-d884f594] {\r\n    max-width: 1400px;\r\n    margin: 0 auto;\n}\n.header-section[data-v-d884f594] {\r\n    background: rgba(255, 255, 255, 0.95);\r\n    backdrop-filter: blur(20px);\r\n    border-radius: 20px;\r\n    padding: 2rem;\r\n    margin-bottom: 2rem;\r\n    box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1);\r\n    border: 1px solid rgba(255, 255, 255, 0.2);\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    flex-wrap: wrap;\r\n    gap: 2rem;\n}\n.page-header h2[data-v-d884f594] {\r\n    color: #2c3e50;\r\n    font-size: 2.2rem;\r\n    font-weight: 700;\r\n    margin: 0 0 0.5rem 0;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    background-clip: text;\r\n    -webkit-background-clip: text;\r\n    -webkit-text-fill-color: transparent;\r\n    display: flex;\r\n    align-items: center;\n}\n.page-description[data-v-d884f594] {\r\n    color: #64748b;\r\n    font-size: 1.1rem;\r\n    margin: 0;\r\n    font-weight: 400;\n}\n.header-actions[data-v-d884f594] {\r\n    display: flex;\r\n    gap: 1rem;\r\n    align-items: center;\r\n    flex-wrap: wrap;\n}\n.search-box[data-v-d884f594] {\r\n    position: relative;\r\n    min-width: 300px;\n}\n.search-icon[data-v-d884f594] {\r\n    position: absolute;\r\n    left: 1rem;\r\n    top: 50%;\r\n    transform: translateY(-50%);\r\n    color: #64748b;\r\n    z-index: 3;\r\n    pointer-events: none;\n}\n.search-input[data-v-d884f594] {\r\n    width: 100%;\r\n    height: 50px;\r\n    padding: 0 1rem 0 3rem !important;\r\n    border: 2px solid #e2e8f0;\r\n    border-radius: 12px;\r\n    font-size: 1rem;\r\n    background: rgba(255, 255, 255, 0.9);\r\n    backdrop-filter: blur(10px);\r\n    transition: all 0.3s ease;\n}\n.search-input[data-v-d884f594]::-moz-placeholder {\r\n    color: #9ca3af;\r\n    padding-left: 0;\n}\n.search-input[data-v-d884f594]::placeholder {\r\n    color: #9ca3af;\r\n    padding-left: 0;\n}\n.search-input[data-v-d884f594]:focus {\r\n    outline: none;\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 0 0 4px rgba(102, 126, 234, 0.1);\r\n    background: white;\n}\n.new-user-btn[data-v-d884f594] {\r\n    height: 50px;\r\n    padding: 0 2rem;\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    color: white;\r\n    border: none;\r\n    border-radius: 12px;\r\n    font-weight: 600;\r\n    font-size: 1rem;\r\n    cursor: pointer;\r\n    transition: all 0.3s ease;\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\r\n    box-shadow: 0 5px 15px rgba(102, 126, 234, 0.3);\n}\n.new-user-btn[data-v-d884f594]:hover {\r\n    transform: translateY(-2px);\r\n    box-shadow: 0 8px 25px rgba(102, 126, 234, 0.4);\n}\r\n\r\n/* Mobile Cards - Hidden by default */\n.mobile-cards-container[data-v-d884f594] {\r\n    display: none;\n}\n.desktop-table[data-v-d884f594] {\r\n    display: block;\n}\r\n\r\n/* Professional Table */\n.professional-table-wrapper[data-v-d884f594] {\r\n    overflow-x: auto;\r\n    -webkit-overflow-scrolling: touch;\n}\n.professional-table[data-v-d884f594] {\r\n    width: 100%;\r\n    border-collapse: separate;\r\n    border-spacing: 0;\r\n    background: white;\r\n    font-size: 0.95rem;\n}\r\n\r\n/* Table Header */\n.professional-table thead th[data-v-d884f594] {\r\n    background: transparent;\r\n    color: #374151;\r\n    font-weight: 700;\r\n    font-size: 0.9rem;\r\n    padding: 1.25rem 1rem;\r\n    border-bottom: 2px solid #e5e7eb;\r\n    position: sticky;\r\n    top: 0;\r\n    z-index: 10;\r\n    white-space: nowrap;\r\n    text-transform: uppercase;\r\n    letter-spacing: 0.5px;\n}\n.professional-table thead th i[data-v-d884f594] {\r\n    margin-right: 0.5rem;\r\n    color: #17a2b8;\n}\r\n\r\n/* Table Body */\n.professional-table tbody tr[data-v-d884f594] {\r\n    transition: all 0.3s ease;\r\n    border-bottom: 1px solid #f1f5f9;\r\n    background: rgba(255, 255, 255, 0.8);\r\n    backdrop-filter: blur(10px);\n}\n.professional-table tbody tr[data-v-d884f594]:hover {\r\n    background: rgba(102, 126, 234, 0.05);\r\n    transform: translateX(5px);\r\n    box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);\n}\n.professional-table tbody td[data-v-d884f594] {\r\n    padding: 1rem;\r\n    vertical-align: middle;\r\n    border-bottom: 1px solid #f1f5f9;\n}\r\n\r\n/* Cell Styles */\n.email-cell[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #1e293b;\n}\n.name-cell[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #1e293b;\n}\n.role-cell[data-v-d884f594] {\r\n    color: #64748b;\r\n    font-weight: 500;\n}\n.user-email[data-v-d884f594], .user-name[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.75rem;\n}\n.user-icon[data-v-d884f594] {\r\n    color: #17a2b8;\r\n    font-size: 1rem;\r\n    width: 20px;\r\n    text-align: center;\n}\n.email-text[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #374151;\r\n    font-size: 1rem;\r\n    background: linear-gradient(135deg, #e0f2fe 0%, #b3e5fc 100%);\r\n    color: #0277bd;\r\n    padding: 0.4rem 0.8rem;\r\n    border-radius: 8px;\r\n    font-weight: 700;\r\n    border: 1px solid #81d4fa;\n}\n.name-text[data-v-d884f594] {\r\n    font-weight: 500;\r\n    color: #374151;\n}\n.role-badge[data-v-d884f594] {\r\n    display: inline-flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\r\n    padding: 0.5rem 1rem;\r\n    border-radius: 20px;\r\n    font-weight: 600;\r\n    font-size: 0.85rem;\r\n    text-transform: uppercase;\r\n    letter-spacing: 0.5px;\n}\n.role-admin[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%);\r\n    color: white;\r\n    box-shadow: 0 3px 10px rgba(251, 191, 36, 0.3);\n}\n.role-client[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #10b981 0%, #059669 100%);\r\n    color: white;\r\n    box-shadow: 0 3px 10px rgba(16, 185, 129, 0.3);\n}\n.role-icon[data-v-d884f594] {\r\n    font-size: 0.8rem;\n}\r\n\r\n/* Action Buttons */\n.action-buttons[data-v-d884f594] {\r\n    display: flex;\r\n    gap: 0.5rem;\r\n    justify-content: center;\n}\n.action-btn[data-v-d884f594] {\r\n    width: 40px;\r\n    height: 40px;\r\n    border-radius: 10px;\r\n    border: none;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    cursor: pointer;\r\n    transition: all 0.3s ease;\r\n    font-size: 1rem;\r\n    text-decoration: none;\n}\n.btn-edit[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);\r\n    color: white;\r\n    box-shadow: 0 5px 15px rgba(59, 130, 246, 0.3);\n}\n.btn-edit[data-v-d884f594]:hover {\r\n    transform: translateY(-2px);\r\n    box-shadow: 0 8px 20px rgba(59, 130, 246, 0.4);\n}\r\n\r\n/* Mobile Cards Styles */\n.user-card[data-v-d884f594] {\r\n    background: white;\r\n    border-radius: 16px;\r\n    padding: 1.5rem;\r\n    margin-bottom: 1rem;\r\n    box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\r\n    border: 1px solid #e5e7eb;\r\n    transition: all 0.3s ease;\n}\n.user-card[data-v-d884f594]:hover {\r\n    transform: translateY(-5px);\r\n    box-shadow: 0 15px 35px rgba(0, 0, 0, 0.15);\n}\n.card-header[data-v-d884f594] {\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    margin-bottom: 1.5rem;\r\n    padding-bottom: 1rem;\r\n    border-bottom: 2px solid #f1f5f9;\n}\n.user-info[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 1rem;\r\n    flex: 1;\n}\n.user-details[data-v-d884f594] {\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 0.5rem;\r\n    flex: 1;\n}\n.user-email-mobile[data-v-d884f594] {\r\n    font-weight: 700;\r\n    color: #0277bd;\r\n    font-size: 1.1rem;\r\n    line-height: 1.2;\n}\n.user-name-mobile[data-v-d884f594] {\r\n    font-weight: 500;\r\n    color: #64748b;\r\n    font-size: 0.95rem;\n}\n.role-container[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\n}\n.role-badge-mobile[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #10b981 0%, #059669 100%);\r\n    color: white;\r\n    padding: 0.5rem 1rem;\r\n    border-radius: 12px;\r\n    font-weight: 700;\r\n    font-size: 0.8rem;\r\n    text-transform: uppercase;\r\n    letter-spacing: 1px;\r\n    display: inline-flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\n}\n.role-badge-mobile.role-admin[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%);\n}\n.card-body[data-v-d884f594] {\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 1rem;\n}\r\n\r\n/* Actions Section Mobile */\n.actions-section[data-v-d884f594] {\r\n    display: flex;\r\n    gap: 1rem;\n}\n.mobile-action-btn[data-v-d884f594] {\r\n    flex: 1;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    gap: 0.75rem;\r\n    padding: 1rem;\r\n    border-radius: 12px;\r\n    font-weight: 600;\r\n    font-size: 1rem;\r\n    cursor: pointer;\r\n    transition: all 0.3s ease;\r\n    text-decoration: none;\r\n    border: none;\n}\n.edit-btn[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);\r\n    color: white;\r\n    box-shadow: 0 5px 15px rgba(59, 130, 246, 0.3);\n}\n.edit-btn[data-v-d884f594]:hover {\r\n    transform: translateY(-2px);\r\n    box-shadow: 0 8px 25px rgba(59, 130, 246, 0.4);\n}\r\n\r\n/* Professional Modal */\n.professional-modal[data-v-d884f594] {\r\n    border-radius: 20px !important;\r\n    overflow: hidden;\r\n    box-shadow: 0 20px 60px rgba(0, 0, 0, 0.2) !important;\n}\n.modal-header[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%) !important;\r\n    color: white !important;\r\n    font-size: 1.3rem !important;\r\n    font-weight: 700 !important;\r\n    padding: 1.5rem 2rem !important;\n}\n.modal-content[data-v-d884f594] {\r\n    padding: 2rem !important;\r\n    background: #f8fafc;\n}\n.field-label[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #374151;\r\n    margin-bottom: 0.5rem;\r\n    display: block;\n}\n.professional-select[data-v-d884f594] {\r\n    border: 2px solid #e2e8f0;\r\n    border-radius: 8px;\r\n    background: white;\n}\n.error-list[data-v-d884f594] {\r\n    background: rgba(239, 68, 68, 0.1);\r\n    border: 1px solid rgba(239, 68, 68, 0.3);\r\n    border-radius: 8px;\r\n    padding: 1rem;\n}\n.error-item[data-v-d884f594] {\r\n    color: #dc2626;\r\n    font-size: 0.9rem;\r\n    margin-bottom: 0.5rem;\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\n}\n.error-item[data-v-d884f594]:last-child {\r\n    margin-bottom: 0;\n}\n.modal-actions[data-v-d884f594] {\r\n    padding: 1.5rem 2rem !important;\r\n    background: white;\r\n    border-top: 1px solid #e2e8f0;\n}\n.cancel-btn[data-v-d884f594] {\r\n    color: #64748b !important;\r\n    font-weight: 600 !important;\n}\n.save-btn[data-v-d884f594] {\r\n    font-weight: 600 !important;\r\n    box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1) !important;\n}\r\n\r\n/* Pagination Styles */\n.pagination-section[data-v-d884f594] {\r\n    background: white;\r\n    border-top: 2px solid #f1f5f9;\r\n    padding: 1.5rem 2rem;\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    flex-wrap: wrap;\r\n    gap: 1rem;\n}\n.pagination-info[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 2rem;\r\n    flex-wrap: wrap;\n}\n.items-per-page[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\n}\n.pagination-label[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #374151;\r\n    font-size: 0.9rem;\n}\n.items-select[data-v-d884f594] {\r\n    padding: 0.5rem 0.75rem;\r\n    border: 2px solid #e5e7eb;\r\n    border-radius: 8px;\r\n    font-size: 0.9rem;\r\n    font-weight: 600;\r\n    color: #374151;\r\n    background: white;\r\n    cursor: pointer;\r\n    outline: none;\r\n    transition: all 0.3s ease;\n}\n.items-select[data-v-d884f594]:focus {\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);\n}\n.page-info-text[data-v-d884f594] {\r\n    font-size: 0.9rem;\r\n    color: #64748b;\r\n    font-weight: 500;\n}\n.pagination-controls[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\n}\n.pagination-btn[data-v-d884f594] {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\r\n    padding: 0.75rem 1rem;\r\n    border: 2px solid #e5e7eb;\r\n    border-radius: 8px;\r\n    background: white;\r\n    color: #374151;\r\n    font-weight: 600;\r\n    font-size: 0.9rem;\r\n    cursor: pointer;\r\n    transition: all 0.3s ease;\n}\n.pagination-btn[data-v-d884f594]:hover:not(:disabled) {\r\n    border-color: #17a2b8;\r\n    color: #17a2b8;\r\n    background: rgba(102, 126, 234, 0.05);\n}\n.pagination-btn[data-v-d884f594]:disabled {\r\n    opacity: 0.5;\r\n    cursor: not-allowed;\r\n    color: #9ca3af;\n}\n.page-numbers[data-v-d884f594] {\r\n    display: flex;\r\n    gap: 0.25rem;\r\n    margin: 0 1rem;\n}\n.page-btn[data-v-d884f594] {\r\n    width: 40px;\r\n    height: 40px;\r\n    border: 2px solid #e5e7eb;\r\n    border-radius: 8px;\r\n    background: white;\r\n    color: #374151;\r\n    font-weight: 600;\r\n    font-size: 0.9rem;\r\n    cursor: pointer;\r\n    transition: all 0.3s ease;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\n}\n.page-btn[data-v-d884f594]:hover:not(:disabled):not(.ellipsis) {\r\n    border-color: #17a2b8;\r\n    color: #17a2b8;\r\n    background: rgba(102, 126, 234, 0.05);\n}\n.page-btn.active[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    color: white;\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 5px 15px rgba(102, 126, 234, 0.3);\n}\n.page-btn.ellipsis[data-v-d884f594] {\r\n    border: none;\r\n    background: transparent;\r\n    cursor: default;\r\n    color: #9ca3af;\n}\n.page-btn.ellipsis[data-v-d884f594]:hover {\r\n    background: transparent;\r\n    border: none;\n}\r\n\r\n/* Responsive Pagination */\n.pagination-section[data-v-d884f594] {\r\n    background: white;\r\n    border-top: 2px solid #f1f5f9;\r\n    padding: 1.5rem 2rem;\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    flex-wrap: wrap;\r\n    gap: 1rem;\n}\n@media (max-width: 768px) {\n.pagination-section[data-v-d884f594] {\r\n        padding: 1rem;\r\n        flex-direction: column;\r\n        align-items: stretch;\r\n        gap: 1rem;\n}\n.pagination-info[data-v-d884f594] {\r\n        justify-content: center;\r\n        flex-direction: column;\r\n        gap: 1rem;\r\n        text-align: center;\n}\n.items-per-page[data-v-d884f594] {\r\n        justify-content: center;\n}\n.pagination-controls[data-v-d884f594] {\r\n        justify-content: center;\r\n        flex-wrap: wrap;\n}\n.page-numbers[data-v-d884f594] {\r\n        margin: 0 0.5rem;\r\n        flex-wrap: wrap;\r\n        justify-content: center;\n}\n.pagination-btn[data-v-d884f594] {\r\n        font-size: 0.8rem;\r\n        padding: 0.6rem 0.8rem;\n}\n.page-btn[data-v-d884f594] {\r\n        width: 35px;\r\n        height: 35px;\r\n        font-size: 0.8rem;\n}\n}\r\n\r\n/* Responsive Design */\n@media (max-width: 1024px) {\n.header-section[data-v-d884f594] {\r\n        flex-direction: column;\r\n        align-items: stretch;\r\n        text-align: center;\n}\n.header-actions[data-v-d884f594] {\r\n        justify-content: center;\n}\n.search-box[data-v-d884f594] {\r\n        min-width: 100%;\n}\n.page-header h2[data-v-d884f594] {\r\n        font-size: 2rem;\r\n        justify-content: center;\n}\n}\n@media (max-width: 900px) {\r\n    /* Show mobile cards, hide desktop table */\n.desktop-table[data-v-d884f594] {\r\n        display: none;\n}\n.mobile-cards-container[data-v-d884f594] {\r\n        display: block;\r\n        padding: 0 0.5rem;\n}\n}\n@media (max-width: 768px) {\n.users-container[data-v-d884f594] {\r\n        padding: 1rem;\n}\n.header-section[data-v-d884f594] {\r\n        border-radius: 16px;\r\n        padding: 1.5rem;\n}\n.professional-report-container[data-v-d884f594] {\r\n        border-radius: 16px;\n}\n.page-header h2[data-v-d884f594] {\r\n        font-size: 1.8rem;\r\n        flex-direction: column;\r\n        text-align: center;\r\n        gap: 0.5rem;\n}\n.user-card[data-v-d884f594] {\r\n        margin-bottom: 1rem;\r\n        padding: 1.25rem;\r\n        border-radius: 14px;\n}\n.card-header[data-v-d884f594] {\r\n        flex-direction: column;\r\n        gap: 1rem;\r\n        align-items: stretch;\r\n        margin-bottom: 1.25rem;\n}\n.user-info[data-v-d884f594] {\r\n        justify-content: center;\r\n        text-align: center;\n}\n.user-email-mobile[data-v-d884f594] {\r\n        font-size: 1rem;\r\n        text-align: center;\n}\n.actions-section[data-v-d884f594] {\r\n        flex-direction: column;\r\n        gap: 0.75rem;\n}\n}\n@media (max-width: 480px) {\n.users-container[data-v-d884f594] {\r\n        padding: 0.75rem;\n}\n.header-section[data-v-d884f594] {\r\n        padding: 1.25rem;\n}\n.page-header h2[data-v-d884f594] {\r\n        font-size: 1.6rem;\n}\n.user-card[data-v-d884f594] {\r\n        padding: 1rem;\r\n        margin-bottom: 0.875rem;\n}\n.user-email-mobile[data-v-d884f594] {\r\n        font-size: 0.95rem;\n}\n.pagination-controls[data-v-d884f594] {\r\n        flex-direction: column;\r\n        gap: 1rem;\n}\n.page-numbers[data-v-d884f594] {\r\n        margin: 0;\r\n        order: 2;\n}\n.prev-btn[data-v-d884f594] {\r\n        order: 1;\r\n        align-self: stretch;\r\n        justify-content: center;\n}\n.next-btn[data-v-d884f594] {\r\n        order: 3;\r\n        align-self: stretch;\r\n        justify-content: center;\n}\n}\r\n\r\n/* Bootstrap Modal Styles */\n#modal-user[data-v-d884f594] .modal-content {\r\n    border-radius: 20px;\r\n    border: none;\r\n    box-shadow: 0 20px 60px rgba(0, 0, 0, 0.2);\r\n    overflow: hidden;\n}\n#modal-user[data-v-d884f594] .modal-header {\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    color: white;\r\n    border: none;\r\n    padding: 1.5rem 2rem;\r\n    font-weight: 700;\n}\n#modal-user[data-v-d884f594] .modal-header .modal-title {\r\n    font-size: 1.3rem;\r\n    font-weight: 700;\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 0.5rem;\n}\n#modal-user[data-v-d884f594] .modal-header .close {\r\n    color: white;\r\n    opacity: 1;\r\n    font-size: 1.5rem;\r\n    text-shadow: none;\n}\n#modal-user[data-v-d884f594] .modal-header .close:hover {\r\n    color: rgba(255, 255, 255, 0.8);\n}\n#modal-user[data-v-d884f594] .modal-body {\r\n    padding: 2rem;\r\n    background: #f8fafc;\n}\n#modal-user .form-control[data-v-d884f594] {\r\n    border: 2px solid #e2e8f0;\r\n    border-radius: 8px;\r\n    padding: 0.75rem 1rem;\r\n    font-size: 1rem;\r\n    transition: all 0.3s ease;\r\n    background: white;\n}\n#modal-user .form-control[data-v-d884f594]:focus {\r\n    border-color: #17a2b8;\r\n    box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);\r\n    outline: none;\n}\n#modal-user .form-control.is-invalid[data-v-d884f594] {\r\n    border-color: #dc3545;\r\n    box-shadow: 0 0 0 3px rgba(220, 53, 69, 0.1);\n}\n#modal-user label[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #374151;\r\n    margin-bottom: 0.5rem;\r\n    display: block;\n}\n#modal-user .invalid-feedback[data-v-d884f594] {\r\n    display: block;\r\n    color: #dc3545;\r\n    font-size: 0.875rem;\r\n    margin-top: 0.25rem;\r\n    font-weight: 500;\n}\n#modal-user .btn[data-v-d884f594] {\r\n    border-radius: 8px;\r\n    font-weight: 600;\r\n    padding: 0.75rem 1.5rem;\r\n    transition: all 0.3s ease;\r\n    border: none;\n}\n#modal-user .btn-outline-primary[data-v-d884f594] {\r\n    border: 2px solid #17a2b8;\r\n    color: #17a2b8;\r\n    background: transparent;\n}\n#modal-user .btn-outline-primary[data-v-d884f594]:hover {\r\n    background: #17a2b8;\r\n    color: white;\r\n    transform: translateY(-1px);\r\n    box-shadow: 0 5px 15px rgba(102, 126, 234, 0.3);\n}\n#modal-user .btn-primary[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);\r\n    color: white;\r\n    box-shadow: 0 5px 15px rgba(102, 126, 234, 0.3);\n}\n#modal-user .btn-primary[data-v-d884f594]:hover {\r\n    transform: translateY(-1px);\r\n    box-shadow: 0 8px 20px rgba(102, 126, 234, 0.4);\n}\n#modal-user .btn-warning[data-v-d884f594] {\r\n    background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);\r\n    color: white;\r\n    box-shadow: 0 5px 15px rgba(245, 158, 11, 0.3);\n}\n#modal-user .btn-warning[data-v-d884f594]:hover {\r\n    transform: translateY(-1px);\r\n    box-shadow: 0 8px 20px rgba(245, 158, 11, 0.4);\n}\n#modal-user .field-label[data-v-d884f594] {\r\n    font-weight: 600;\r\n    color: #374151;\r\n    margin-bottom: 0.5rem;\r\n    display: block;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_style_index_0_id_d884f594_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_style_index_0_id_d884f594_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=template&id=d884f594&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=template&id=d884f594&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    staticClass: "btn btn-primary new-user-btn",
    on: {
      click: _vm.newUser
    }
  }, [_c("i", {
  ...
  }, [_vm._m(2), _vm._v(" "), _c("tbody", _vm._l(_vm.paginatedUsuarios, function (item, index) {
    return _c("tr", {
      key: index,
      staticClass: "data-row"
    }, [_c("td", {
      staticClass: "text-left email-cell"
    }, [_c("div", {
      staticClass: "user-email"
    }, [_c("i", {
      staticClass: "fas fa-envelope user-icon"
    }), _vm._v(" "), _c("span", {
      staticClass: "email-text"
    }, [_vm._v(_vm._s(item.email))])])]), _vm._v(" "), _c("td", {
      staticClass: "text-left name-cell"
    }, [_c("div", {
      staticClass: "user-name"
    }, [_c("i", {
      staticClass: "fas fa-user user-icon"
    }), _vm._v(" "), _c("span", {
      staticClass: "name-text"
    }, [_vm._v(_vm._s(item.name))])])]), _vm._v(" "), _c("td", {
      staticClass: "text-center role-cell"
    }, [_c("span", {
      staticClass: "role-badge",
      "class": item.role_id === 1 ? "role-admin" : "role-client"
    }, [_c("i", {
      staticClass: "role-icon",
      "class": item.role_id === 1 ? "fas fa-crown" : "fas fa-user-tag"
    }), _vm._v("\n                                            " + _vm._s(item.role_id === 1 ? "Admin" : "Cliente") + "\n                                        ")])]), _vm._v(" "), _c("td", {
  ...
  }, _vm._l(_vm.paginatedUsuarios, function (item, index) {
    return _c("div", {
      key: index,
      ...
      staticClass: "user-email-mobile"
    }, [_vm._v(_vm._s(item.email))]), _vm._v(" "), _c("span", {
      staticClass: "user-name-mobile"
    }, [_vm._v(_vm._s(item.name))])]), _vm._v(" "), _c("div", {
      staticClass: "role-container"
    }, [_c("span", {
      staticClass: "role-badge-mobile",
      "class": item.role_id === 1 ? "role-admin" : "role-client"
    }, [_c("i", {
      staticClass: "role-icon",
      "class": item.role_id === 1 ? "fas fa-crown" : "fas fa-user-tag"
  ...
  }), 0), _vm._v(" "), _vm.filteredUsuarios.length > 0 ? _c("div", {
  ...
  }, [_vm._v("Rol del usuario")]), _vm._v(" "), _c("b-form-select", {
    "class": {
      "is-invalid": _vm.hasError("role_id")
    },
    attrs: {
      id: "role_id",
      options: _vm.roles
  ...
  }), _vm._v(" "), _vm.hasError("role_id") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("role_id")))]) : _vm._e()], 1), _vm._v(" "), _vm.user.role_id === 2 ? _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    staticClass: "field-label"
  }, [_vm._v("Asociar a un cliente")]), _vm._v(" "), _c("model-select", {
    "class": {
      "is-invalid": _vm.hasError("cliente_id")
    },
    attrs: {
    ...
    model: {
      value: _vm.user.cliente_id,
      callback: function callback($$v) {
        _vm.$set(_vm.user, "cliente_id", $$v);
      },
      expression: "user.cliente_id"
    }
  }), _vm._v(" "), _vm.hasError("cliente_id") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("cliente_id")))]) : _vm._e()], 1) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "email"
  ...
  }), _vm._v(" "), _vm.hasError("email") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("email")))]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("label", {
    attrs: {
      "for": "name"
  ...
  }), _vm._v(" "), _vm.hasError("name") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("name")))]) : _vm._e()]), _vm._v(" "), _vm.editedIndex === -1 ? _c("div", {
    staticClass: "col-12"
  }, [_c("label", {
    attrs: {
      "for": "password"
    ...
    staticClass: "form-control",
    "class": {
      "is-invalid": _vm.hasError("password")
    },
    attrs: {
      type: "password",
      id: "password"
  ...
  }), _vm._v(" "), _vm.hasError("password") ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.firstError("password")))]) : _vm._e()]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "col-6"
  }, [_c("button", {
    ...
    staticClass: "fas fa-window-close mr-2"
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Cargando usuarios...")]), _vm._v(" "), _c("p", {
    staticClass: "loading-subtitle"
  }, [_vm._v("Por favor espera mientras obtenemos la información")])])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./User.vue?vue&type=template&id=d884f594&scoped=true */ "./resources/js/components/User.vue?vue&type=template&id=d884f594&scoped=true");
...
/* harmony import */ var _User_vue_vue_type_style_index_0_id_d884f594_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css */ "./resources/js/components/User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "d884f594",
  null
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_style_index_0_id_d884f594_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=style&index=0&id=d884f594&scoped=true&lang=css");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_User_vue_vue_type_template_id_d884f594_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./User.vue?vue&type=template&id=d884f594&scoped=true */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/User.vue?vue&type=template&id=d884f594&scoped=true");
